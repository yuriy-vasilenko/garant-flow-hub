...
export const products: Product[] = [
  {
    ...
    category: 'Насосы',
    categorySlug: 'nasosy',
    subcategorySlug: 'cirkulyacionnye',
    price: 8500,
    status: 'available',
