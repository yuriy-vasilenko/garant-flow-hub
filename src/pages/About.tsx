...
const About = () => (
  <PageLayout>
    <PageHeader
      title="О компании"
      description="Гарант Маркет — надёжный поставщик инженерного оборудования в Донецке"
      ...
      <div className="container mx-auto px-4 max-w-3xl space-y-8">
        <div className="prose prose-slate max-w-none">
          <p className="text-lg text-muted-foreground leading-relaxed">
            Гарант Маркет — компания, специализирующаяся на продаже товаров для отопления, водоснабжения, инженерной сантехники и водоподготовки. Мы работаем с проверенными производителями и предлагаем широкий ассортимент оборудования как для бытового, так и для коммерческого применения.
          </p>
        </div>
